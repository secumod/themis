 ...
 *
 * secret             -> value to compare of each peer (x - for Alice, y - for
 * Bob)
 * rand, rand2, rand3 -> random values of each peer(r, a2, a3 - for Alice; s,
 * b2, b3 - for Bob)
 * g2, g3, P, Q       -> intermediate parameters of each peer while protocol
 * execution (G2a, G3a, Pa, Qa - for Alice; G2b, G3b, Pb, Qb - for Bob)
